    ...
    <div class="update-basic-now" >
        <a href="<?php echo $url; ?>basic/?utm_source=dashboard&utm_medium=banner-<?php echo $lang; ?>&utm_campaign=basic-pro#pro"
           target="_blank" style="">
            ...
            <?php _e( 'Update Basic to 1.4 now!', 'basic' ); ?>
        </a>
    </div>
	<?php
...
.update-basic-now img{transition:transform 0.3s;position:absolute;left: 20px;top:50%;margin-top:-14px;}
.update-basic-now a:hover img{transform: rotate(90deg)}
</style>
    <?php
